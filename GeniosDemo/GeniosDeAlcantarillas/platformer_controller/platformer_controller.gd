...
export var input_run : String = "player_run"

# The max jump height in pixels (holding jump)
export var max_jump_height = 200 setget set_max_jump_height
# The minimum jump height (tapping jump)
export var min_jump_height = 150 setget set_min_jump_height
...
export var jump_duration = 0.42 setget set_jump_duration
# Multiplies the gravity by this while falling
export var falling_gravity_multiplier = 1
...
func _physics_process(delta):
	...
	if (is_on_floor()==true && max_acceleration!=4000) || max_acceleration==4000:
	...
	if Input.is_action_pressed(input_run) && acc.x==-max_acceleration:
		$Sprite.play("Run")
		$Sprite.flip_h=true
	...
	if Input.is_action_pressed(input_run) && acc.x==max_acceleration:
		$Sprite.play("Run")
		max_acceleration=8000
	if Input.is_action_pressed(input_run)==false:
		$Sprite.play("Run")
...
#		max_speed=20000
#	if Input.is_action_pressed("player_run")==false:
#		max_speed=100
